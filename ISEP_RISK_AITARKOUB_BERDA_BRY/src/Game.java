...
public class Game {
    ...
    public void territoriesInitialization() {
        ...
        System.out.println("Nombre de joueurs : " + this.playersList.size());
        ...
        for (int i = 0; i < listTerritories.size(); i++) {
            ...
            System.out.println("Couleur : " + this.listTerritories.get(randomTerritoriesList.get(i)).getOwner().getPlayerColor());

            this.playersList.get(indexPlayer).addTerritory(1); //on ajoute un territoire à sa liste de territoires qu'il possède

            indexPlayer++;

            // Si l'index des joueurs est égal à la longueur de la liste des joueurs (donc au nombre de joueurs), on remet l'index à 0 pour continuer à distribuer les territoires aléatoirement et au même nombre pour chacun
        ...
        //On associe chaque rectangle de la map au territoire correspondant
        ...
        System.out.println("Nombre de territoires : : " + this.listRectangles.size());
